...
module.exports.handleEvent = async function({ api, event, args, Threads, Users }) {
  ...
  if ((event.body.toLowerCase() == "riyaz") || (event.body.toLowerCase() == "RIYAZ") || (event.body.toLowerCase() == "রিয়াজ ভাই") || (event.body.toLowerCase() == "রিয়াজ")) {
     return api.sendMessage("রিয়াজ বস  এখন কাজে বিজি আছে কি বলবেন আমাকে বলতে পারেন..!😘",threadID);
   ...
   if ((event.body.toLowerCase() == "Tor boss ke") || (event.body.toLowerCase() == "admin ke ")) {
     return api.sendMessage("My Creator:রিয়াজ ❤️ হাই আমি মেছেন্জার ROBOT  আামার বস রিয়াজ আমাকে বানিয়েছেন আপনাদের কে হাসানোর জন্য আমি চাই আপনারা সব সময় হাসি খুশি থাকেন", threadID);
   };

  if ((event.body.toLowerCase() == "admin") || (event.body.toLowerCase() == "boter admin")) {
     return api.sendMessage("He is Riyaz ッ❤️ তাকে সবাই রিয়াজ নামে  চিনে🤙", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "আসসালামু আলাইকুম") || (event.body.toLowerCase() == "Assalamualaikum") || (event.body.toLowerCase() == "Assalamu alaikum") || (event.body.toLowerCase() == "Salam ")) {
   ...
   if ((event.body.toLowerCase() == "sala ami tor boss") || (event.body.toLowerCase() == "sala ami riyaz") || (event.body.toLowerCase() == "cup sala ami riyaz") || (event.body.toLowerCase() == "madari")) {
     return api.sendMessage("সরি বস মাফ করে দেন আর এমন ভুল হবে না🥺🙏", threadID);
   };

   if ((event.body.toLowerCase() == "@Farhana Ontora") || (event.body.toLowerCase() == "@Mim ")) {
     return api.sendMessage("খবরদার কেউ এই আইডি মেনশন দিবানা এটা আমার বস রিয়াজ এর বউ এর আইডি 😠🥰⛏️", threadID);
   };

  if ((event.body.toLowerCase() == "Farhana") || (event.body.toLowerCase() == "arohi")) {
     return api.sendMessage("খবরদার কেউ এই নাম দরে ডাক দিবানা এটা আমার বস রিয়াজ এর বউ এর নাম..!😠🥰⛏️", threadID);
   };
  ...
  if ((event.body.toLowerCase() == "Saeid") || (event.body.toLowerCase() == "সাইদ")) {
     return api.sendMessage("🥰-তামিম-🌺 আমার বস রিয়াজ এর দুলাভাই লাগে লুচ্ছা বেডি'রা দূরে থাক😠🥰⛏️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tnx") || (event.body.toLowerCase() == "ধন্যবাদ") || (event.body.toLowerCase() == "thank you") || (event.body.toLowerCase() == "thanks")) {
     return api.sendMessage("️এতো ধন্যবাদ না দিয়ে আমার বস রিয়াজ কে একটা গার্লফ্রেন্ড  দে..!🌚⛏️🌶️", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "হুম") || (event.body.toLowerCase() == "Hmm")) {
     return api.sendMessage("️হুম চোদাইস না আমার বস রিয়াজ এর মাথা এমনিতেই গরম আছে 🤬⛏️😷", threadID);
   };

   if ((event.body.toLowerCase() == "Name") || (event.body.toLowerCase() == "name") || (event.body.toLowerCase() == "Tor nam ki")) {
     return api.sendMessage("️MY NAME IS °_>RIYAZ ER BOT", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "cudi") || (event.body.toLowerCase() == "চুদি")) {
     return api.sendMessage("️এত চোদা চুদি করস কেনো' দেখা যাবে বাসর-রাতে-তুই-কতো পারিস' না পারলে আমার বস রিয়াজ কে ডাকিস..!🥱🌝🌚⛏️🌶️ ", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "😒") || (event.body.toLowerCase() == "🙄")) {
     return api.sendMessage("️ এইদিকে ওইদিকে কি দেখো জানু' আমার রিয়াজ বস তোমার সামনে দেখো😘😛", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "🥰") || (event.body.toLowerCase() == "😍") || (event.body.toLowerCase() == "😻") || (event.body.toLowerCase() == "❤️")) {
     return api.sendMessage("ভালোবাসা নামক আবলামী করতে চাইলে রিয়াজ বস এর  ইনবক্সে চলে যা পাগল ছাগল🌚🐸🌶️🍆", threadID);
   };
   ...
   if ((event.body.toLowerCase() == "tumi ki amake bhalobaso") || (event.body.toLowerCase() == "তুমি কি আমাকে ভালোবাসো")) {
     return api.sendMessage("হুম ঝাং আমার রিয়াজ বস তোমাকে রাইতে ভলোপাসে <🥵", threadID);
   };

   if ((event.body.toLowerCase() == "ami riyaz") || (event.body.toLowerCase() == "আমি রিয়াজ")) {
     return api.sendMessage("হ্যা রিয়াজ বস কেমন আছেন..?☺️", threadID);
   };
  mess = "{name}"
